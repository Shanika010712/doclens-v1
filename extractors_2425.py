...
def balance_2425_multiple(image):
  details = vision_model.generate_content([balance_2425_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
def wealth_2425(image): # Renamed function
...
def wealth_2425_multiple(image): # Renamed function
  details = vision_model.generate_content([wealth_2425_prompt, *image],safety_settings={ # Use updated prompt var
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
#employment
def employment_2425(image): # Renamed function
...
def employment_2425_multiple(image): # Renamed function
  details = vision_model.generate_content([emp_2425_prompt, *image],safety_settings={ # Use updated prompt var
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
#bank
def int_inc_2425(image): # Renamed function
...
#bank month
def int_inc_2425_m(image): # Renamed function
...
#bank quarter
def int_inc_2425_q(image): # Renamed function
...
#bank year
def int_inc_2425_multiple(image): # Renamed function
...
#bank month
def int_inc_2425_m_multiple(image): # Renamed function
...
def int_inc_com_2425_m_multiple(image): # Renamed function
...
def int_inc_hsbc_2425_m_multiple(image): # Renamed function
...
def int_inc_hnb_2425_m_multiple(image): # Renamed function
...
#def int_inc_seylan_2425_m_multiple(image): # Renamed function
...
#bank quarter
def int_inc_2425_q_multiple(image): # Renamed function
