...
def balance_2324_multiple(image):
  details = vision_model.generate_content([balance_2324_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
def wealth_2324_multiple(image):
  details = vision_model.generate_content([wealth_2324_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
def employment_2324_multiple(image):
  details = vision_model.generate_content([emp_2324_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
#bank year 
def int_inc_2324_multiple(image):
...
#bank month
def int_inc_2324_m_multiple(image):
...
def int_inc_com_2324_m_multiple(image):
...
def int_inc_hsbc_2324_m_multiple(image):
...
def int_inc_hnb_2324_m_multiple(image):
...
def int_inc_seylan_2324_m_multiple(image):
