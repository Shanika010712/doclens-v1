...
#calling prompts
emp_1920_prompt = read_file_content(os.path.join(SCRIPT_DIR, emp_1920_txt))
int_1920_prompt = read_file_content(os.path.join(SCRIPT_DIR, int_inc_1920_txt))
int_1920_m_prompt = read_file_content(os.path.join(SCRIPT_DIR, int_inc_1920m_txt))
int_1920_q_prompt = read_file_content(os.path.join(SCRIPT_DIR, int_inc_1920q_txt))
int_balance_prompt= read_file_content(os.path.join(SCRIPT_DIR, int_balance_1920_txt))
wealth_1920_prompt = read_file_content(os.path.join(SCRIPT_DIR, wealth_1920_txt))

#for multiple images
int_1920_multi_prompt = read_file_content(os.path.join(SCRIPT_DIR, int_inc_1920_multi_txt))
int_1920_m_multi_prompt = read_file_content(os.path.join(SCRIPT_DIR, int_inc_1920m_multi_txt))
int_1920_q_multi_prompt = read_file_content(os.path.join(SCRIPT_DIR, int_inc_1920q_multi_txt))


def balance_1920(image):
...
def balance_1920_multiple(image):
  details = vision_model.generate_content([int_balance_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
def wealth_1920_multiple(image):
  details = vision_model.generate_content([wealth_1920_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
def employment_1920_multiple(image):
  details = vision_model.generate_content([emp_1920_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
#bank year 
def int_inc_1920_multiple(image):
...
#bank month
def int_inc_1920_m_multiple(image):
...
#bank quarter
def int_inc_1920_q_multiple(image):
