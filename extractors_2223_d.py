...
def balance_2223_multiple_d(image):
    details = vision_model.generate_content([balance_2223_prompt, *image],safety_settings={
            'HATE': 'BLOCK_NONE',
            'HARASSMENT': 'BLOCK_NONE',
            'SEXUAL' : 'BLOCK_NONE',
...
def wealth_2223_multiple_d(image_list):
...
def employment_2223_multiple_d(image_list): # Renamed 'image' to 'image_list' for clarity
...
#bank year 
def int_inc_2223_multiple_d(image_list):
...
#bank month
def int_inc_2223_m_multiple_d(image_list):
...
#bank quarter
def int_inc_2223_q_multiple_d(image_list):
