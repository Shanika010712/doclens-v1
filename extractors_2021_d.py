...
#calling prompts
emp_2021_prompt = read_file_content_txt(os.path.join(SCRIPT_DIR, emp_2021_txt))
int_2021_prompt = read_file_content_txt(os.path.join(SCRIPT_DIR, int_inc_2021_txt))
int_2021_m_prompt = read_file_content_txt(os.path.join(SCRIPT_DIR, int_inc_2021m_txt))
int_2021_q_prompt = read_file_content_txt(os.path.join(SCRIPT_DIR, int_inc_2021q_txt))
wealth_2021_prompt= read_file_content_txt(os.path.join(SCRIPT_DIR, wealth_2021_txt))
balance_2021_prompt=read_file_content_txt(os.path.join(SCRIPT_DIR, int_balance_2021_txt))

#for multiple images
int_2021_multi_prompt = read_file_content_txt(os.path.join(SCRIPT_DIR, int_inc_2021_multi_txt))
int_2021_m_multi_prompt = read_file_content_txt(os.path.join(SCRIPT_DIR, int_inc_2021m_multi_txt))
int_2021_q_multi_prompt = read_file_content_txt(os.path.join(SCRIPT_DIR, int_inc_2021q_multi_txt))

def balance_2021_d(image):
...
def balance_2021_multiple_d(image):
  details = vision_model.generate_content([balance_2021_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
def wealth_2021_multiple_d(image):
  details = vision_model.generate_content([wealth_2021_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
def employment_2021_multiple_d(image):
  details = vision_model.generate_content([emp_2021_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
#bank year 
def int_inc_2021_multiple_d(image):
...
#bank month
def int_inc_2021_m_multiple_d(image):
...
#bank quarter
def int_inc_2021_q_multiple_d(image):
