...
def balance_2122_multiple_d(image):
  details = vision_model.generate_content([int_balance_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
def wealth_2122_multiple_d(image):
  details = vision_model.generate_content([wealth_2122_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
def employment_2122_multiple_d(image):
  details = vision_model.generate_content([emp_2122_prompt, *image],safety_settings={
        'HATE': 'BLOCK_NONE',
        'HARASSMENT': 'BLOCK_NONE',
        'SEXUAL' : 'BLOCK_NONE',
...
#bank year 
def int_inc_2122_multiple_d(image):
...
#bank month
def int_inc_2122_m_multiple_d(image):
...
#bank quarter
def int_inc_2122_q_multiple_d(image):
